...
export async function antilink(client, message) {
    ...
    try {
        ...
        if (!action) {
            const usage = `🔒 *Pretty girl - Antilink*\n\n.antilink on\n.antilink off\n.antilink set delete | kick | warn\n.antilink status`
        ...
        switch (action) {
            ...
            case 'off':
                ...
                await client.sendMessage(groupId, { 
                    text: '❌ *Antilink pretty désactiver*' 
                })
                break
...
export async function kickall(client, message) {
    ...
    try {
        ...
        await client.sendMessage(groupId, { text: '⚡ pretty girl - Purge...' })
...
export async function kickall2(client, message) {
    ...
    try {
        ...
        await client.sendMessage(groupId, { text: '⚡ pretty girl md - One Shot...' })
